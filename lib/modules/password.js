...
var renderRegisterFail = renderGenerator('register',
  function (errors, newUserAttributes) {
    return {
      errors: errors, userParams: newUserAttributes};
  }
);
  ...
  everyModule.submodule('password')
    .configurable({
      loginFormFieldName: 'the name of the login field. Same as what you put in your login form '
        ...
        'that corresponds to the register page.', registerLayout: 'the name or path to the layout you want to use for your registration page', registerLocals: 'Configure extra locals to pass to your register/registration view', registerSuccessRedirect: 'The path we redirect to after a successful registration.'
    })
...
password.validLoginTypes({
  login: {}, email: {
    validate: validateEmail, error: 'Please correct your email.'
  }, phone: {
