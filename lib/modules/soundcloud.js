...
var soundcloud = module.exports =
  oauthModule.submodule('soundcloud')
    .configurable({
      scope: 'specify types of access: (no scope), non-expiring', display: 'specify type of auth dialog: (no display), popup'
    })
    ...
    .fetchOAuthUser(function (accessToken) {
      ...
      request.get({
        url: this.apiHost() + '/me.json', qs: {oauth_token: accessToken}
