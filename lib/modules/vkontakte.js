...
var vkontakte = module.exports =
  oauthModule.submodule('vkontakte')
    .configurable({
      display: 'set to "touch" if you want users to see a mobile optimized version of the auth page', scope: 'specify types of access: See http://vk.com/developers.php?oid=-1&p=Права_доступа_приложений', fields: 'specify fields of profile: See http://vk.com/developers.php?oid=-1&p=Описание_полей_параметра_fields'
    })
