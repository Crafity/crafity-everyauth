...
var instagram = module.exports =
  oauthModule.submodule('instagram')
    .configurable({
      display: 'set to "touch" if you want users to see a mobile optimized version of the auth page', scope: 'specify types of access (space separated if > 1): basic (default), comments, relationships, likes'
    })
